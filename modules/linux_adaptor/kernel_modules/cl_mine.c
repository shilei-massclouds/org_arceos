...
CL_MINE(acpi_rintc_ext_parent_to_hartid)
CL_MINE(acpi_rintc_get_plic_context)
CL_MINE(acpi_rintc_get_plic_nr_contexts)
CL_MINE(bitmap_free)
CL_MINE(bitmap_zalloc)
CL_MINE(cpu_bit_bitmap)
CL_MINE(__cpuhp_setup_state)
CL_MINE(__cpu_online_mask)
CL_MINE(__cpu_present_mask)
CL_MINE(devm_platform_ioremap_resource)
CL_MINE(enable_percpu_irq)
CL_MINE(generic_handle_domain_irq)
CL_MINE(handle_edge_irq)
CL_MINE(irq_create_mapping_affinity)
CL_MINE(irq_domain_instantiate)
CL_MINE(irq_domain_set_info)
CL_MINE(irq_domain_translate_onecell)
CL_MINE(irq_domain_translate_twocell)
CL_MINE(irq_find_matching_fwspec)
CL_MINE(irq_get_irq_data)
CL_MINE(irq_modify_status)
CL_MINE(irq_set_affinity)
CL_MINE(__irq_set_handler)
CL_MINE(is_acpi_device_node)
CL_MINE(kfree)
CL_MINE(__kmalloc_cache_noprof)
CL_MINE(kmalloc_caches)
CL_MINE(__kmalloc_noprof)
CL_MINE(__mmiowb_state)
CL_MINE(of_fwnode_ops)
CL_MINE(of_iomap)
CL_MINE(of_irq_count)
CL_MINE(of_irq_parse_one)
CL_MINE(of_match_node)
CL_MINE(of_property_read_variable_u32_array)
CL_MINE(__per_cpu_offset)
...
CL_MINE(riscv_get_intc_hwnode)
CL_MINE(riscv_hartid_to_cpuid)
CL_MINE(riscv_of_parent_hartid)
