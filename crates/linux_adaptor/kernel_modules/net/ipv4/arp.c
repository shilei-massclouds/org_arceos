...
{
	pr_warn("arp_init: enter\n");
	pr_warn("arp_init: neigh_table_init\n");
	neigh_table_init(NEIGH_ARP_TABLE, &arp_tbl);

	pr_warn("arp_init: dev_add_pack\n");
	dev_add_pack(&arp_packet_type);
	pr_warn("arp_init: register_pernet_subsys\n");
	register_pernet_subsys(&arp_net_ops);
#ifdef CONFIG_SYSCTL
	pr_warn("arp_init: neigh_sysctl_register\n");
	neigh_sysctl_register(NULL, &arp_tbl.parms, NULL);
#endif
	pr_warn("arp_init: register_netdevice_notifier\n");
	register_netdevice_notifier(&arp_netdev_notifier);
	pr_warn("arp_init: done\n");
}
