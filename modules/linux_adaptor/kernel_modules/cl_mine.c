...
CL_MINE(acpi_reconfig_notifier_register)
...
CL_MINE(__devm_alloc_percpu)
CL_MINE(devm_clk_get)
CL_MINE(devm_gpiod_get_index_optional)
CL_MINE(devm_request_threaded_irq)
...
CL_MINE(of_alias_from_compatible)
CL_MINE(of_alias_get_highest_id)
CL_MINE(of_alias_get_id)
CL_MINE(__pm_runtime_idle)
