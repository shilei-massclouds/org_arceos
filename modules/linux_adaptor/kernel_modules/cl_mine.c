...
CL_MINE(iget_locked)
CL_MINE(__init_rwsem)
CL_MINE(__init_swait_queue_head)
CL_MINE(init_timer_key)
CL_MINE(init_uts_ns)
CL_MINE(__init_waitqueue_head)
...
CL_MINE(jbd2_complete_transaction)
CL_MINE(jbd2_inode_cache)
CL_MINE(jbd2_journal_abort)
CL_MINE(jbd2_journal_begin_ordered_truncate)
CL_MINE(jbd2_journal_blocks_per_page)
CL_MINE(jbd2_journal_check_available_features)
CL_MINE(jbd2_journal_clear_err)
CL_MINE(jbd2_journal_clear_features)
CL_MINE(jbd2_journal_destroy)
CL_MINE(jbd2_journal_dirty_metadata)
CL_MINE(jbd2_journal_errno)
CL_MINE(jbd2_journal_extend)
CL_MINE(jbd2_journal_flush)
CL_MINE(jbd2_journal_force_commit)
CL_MINE(jbd2_journal_force_commit_nested)
CL_MINE(jbd2_journal_forget)
CL_MINE(jbd2_journal_free_reserved)
CL_MINE(jbd2_journal_get_create_access)
CL_MINE(jbd2_journal_get_write_access)
CL_MINE(jbd2_journal_init_dev)
CL_MINE(jbd2_journal_init_inode)
CL_MINE(jbd2_journal_init_jbd_inode)
CL_MINE(jbd2_journal_inode_ranged_wait)
CL_MINE(jbd2_journal_inode_ranged_write)
CL_MINE(jbd2_journal_invalidatepage)
CL_MINE(jbd2_journal_load)
CL_MINE(jbd2_journal_lock_updates)
CL_MINE(jbd2_journal_release_jbd_inode)
CL_MINE(jbd2__journal_restart)
CL_MINE(jbd2_journal_revoke)
CL_MINE(jbd2_journal_set_features)
CL_MINE(jbd2__journal_start)
CL_MINE(jbd2_journal_start_commit)
CL_MINE(jbd2_journal_start_reserved)
CL_MINE(jbd2_journal_stop)
CL_MINE(jbd2_journal_try_to_free_buffers)
CL_MINE(jbd2_journal_unlock_updates)
CL_MINE(jbd2_journal_update_sb_errno)
CL_MINE(jbd2_journal_wipe)
CL_MINE(jbd2_log_wait_commit)
CL_MINE(jbd2_transaction_committed)
CL_MINE(jbd2_trans_will_send_data_barrier)
CL_MINE(jiffies)
CL_MINE(kern_path)
CL_MINE(kmem_cache_create)
...
CL_MINE(submit_bh)
CL_MINE(submit_bio)
CL_MINE(submit_bio_wait)
CL_MINE(sync_blockdev)
CL_MINE(__sync_dirty_buffer)
...
CL_MINE(__test_set_page_writeback)
CL_MINE(thaw_bdev)
CL_MINE(touch_atime)
