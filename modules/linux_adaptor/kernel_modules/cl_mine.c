...
CL_MINE(ext2_fast_symlink_inode_operations)
CL_MINE(ext2_symlink_inode_operations)
CL_MINE(from_kgid)
CL_MINE(from_kuid)
...
CL_MINE(d_tmpfile)
CL_MINE(ext2_add_link)
CL_MINE(ext2_delete_entry)
CL_MINE(ext2_dir_operations)
CL_MINE(ext2_dotdot)
CL_MINE(ext2_empty_dir)
CL_MINE(ext2_find_entry)
CL_MINE(ext2_inode_by_name)
CL_MINE(ext2_make_empty)
CL_MINE(ext2_set_link)
CL_MINE(ihold)
CL_MINE(inc_nlink)
CL_MINE(iput)
...
// ext2/super
CL_MINE(d_make_root)
CL_MINE(ext2_bg_has_super)
CL_MINE(ext2_bg_num_gdb)
CL_MINE(ext2_count_dirs)
CL_MINE(ext2_count_free_blocks)
CL_MINE(ext2_count_free_inodes)
CL_MINE(ext2_evict_inode)
CL_MINE(ext2_get_group_desc)
CL_MINE(ext2_get_parent)
CL_MINE(ext2_iget)
CL_MINE(ext2_rsv_window_add)
CL_MINE(ext2_write_inode)
