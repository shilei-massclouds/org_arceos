...
#define TASK_THREAD_RA 2744 /* offsetof(struct task_struct, thread.ra) */
#define TASK_THREAD_SP 2752 /* offsetof(struct task_struct, thread.sp) */
#define TASK_THREAD_S0 2760 /* offsetof(struct task_struct, thread.s[0]) */
#define TASK_THREAD_S1 2768 /* offsetof(struct task_struct, thread.s[1]) */
#define TASK_THREAD_S2 2776 /* offsetof(struct task_struct, thread.s[2]) */
#define TASK_THREAD_S3 2784 /* offsetof(struct task_struct, thread.s[3]) */
#define TASK_THREAD_S4 2792 /* offsetof(struct task_struct, thread.s[4]) */
#define TASK_THREAD_S5 2800 /* offsetof(struct task_struct, thread.s[5]) */
#define TASK_THREAD_S6 2808 /* offsetof(struct task_struct, thread.s[6]) */
#define TASK_THREAD_S7 2816 /* offsetof(struct task_struct, thread.s[7]) */
#define TASK_THREAD_S8 2824 /* offsetof(struct task_struct, thread.s[8]) */
#define TASK_THREAD_S9 2832 /* offsetof(struct task_struct, thread.s[9]) */
#define TASK_THREAD_S10 2840 /* offsetof(struct task_struct, thread.s[10]) */
#define TASK_THREAD_S11 2848 /* offsetof(struct task_struct, thread.s[11]) */
...
#define TASK_TI_A0 48 /* offsetof(struct task_struct, thread_info.a0) */
#define TASK_TI_A1 56 /* offsetof(struct task_struct, thread_info.a1) */
#define TASK_TI_A2 64 /* offsetof(struct task_struct, thread_info.a2) */
#define TASK_TI_CPU_NUM 32 /* offsetof(struct task_struct, thread_info.cpu) */
#define TASK_THREAD_F0 2856 /* offsetof(struct task_struct, thread.fstate.f[0]) */
#define TASK_THREAD_F1 2864 /* offsetof(struct task_struct, thread.fstate.f[1]) */
#define TASK_THREAD_F2 2872 /* offsetof(struct task_struct, thread.fstate.f[2]) */
#define TASK_THREAD_F3 2880 /* offsetof(struct task_struct, thread.fstate.f[3]) */
#define TASK_THREAD_F4 2888 /* offsetof(struct task_struct, thread.fstate.f[4]) */
#define TASK_THREAD_F5 2896 /* offsetof(struct task_struct, thread.fstate.f[5]) */
#define TASK_THREAD_F6 2904 /* offsetof(struct task_struct, thread.fstate.f[6]) */
#define TASK_THREAD_F7 2912 /* offsetof(struct task_struct, thread.fstate.f[7]) */
#define TASK_THREAD_F8 2920 /* offsetof(struct task_struct, thread.fstate.f[8]) */
#define TASK_THREAD_F9 2928 /* offsetof(struct task_struct, thread.fstate.f[9]) */
#define TASK_THREAD_F10 2936 /* offsetof(struct task_struct, thread.fstate.f[10]) */
#define TASK_THREAD_F11 2944 /* offsetof(struct task_struct, thread.fstate.f[11]) */
#define TASK_THREAD_F12 2952 /* offsetof(struct task_struct, thread.fstate.f[12]) */
#define TASK_THREAD_F13 2960 /* offsetof(struct task_struct, thread.fstate.f[13]) */
#define TASK_THREAD_F14 2968 /* offsetof(struct task_struct, thread.fstate.f[14]) */
#define TASK_THREAD_F15 2976 /* offsetof(struct task_struct, thread.fstate.f[15]) */
#define TASK_THREAD_F16 2984 /* offsetof(struct task_struct, thread.fstate.f[16]) */
#define TASK_THREAD_F17 2992 /* offsetof(struct task_struct, thread.fstate.f[17]) */
#define TASK_THREAD_F18 3000 /* offsetof(struct task_struct, thread.fstate.f[18]) */
#define TASK_THREAD_F19 3008 /* offsetof(struct task_struct, thread.fstate.f[19]) */
#define TASK_THREAD_F20 3016 /* offsetof(struct task_struct, thread.fstate.f[20]) */
#define TASK_THREAD_F21 3024 /* offsetof(struct task_struct, thread.fstate.f[21]) */
#define TASK_THREAD_F22 3032 /* offsetof(struct task_struct, thread.fstate.f[22]) */
#define TASK_THREAD_F23 3040 /* offsetof(struct task_struct, thread.fstate.f[23]) */
#define TASK_THREAD_F24 3048 /* offsetof(struct task_struct, thread.fstate.f[24]) */
#define TASK_THREAD_F25 3056 /* offsetof(struct task_struct, thread.fstate.f[25]) */
#define TASK_THREAD_F26 3064 /* offsetof(struct task_struct, thread.fstate.f[26]) */
#define TASK_THREAD_F27 3072 /* offsetof(struct task_struct, thread.fstate.f[27]) */
#define TASK_THREAD_F28 3080 /* offsetof(struct task_struct, thread.fstate.f[28]) */
#define TASK_THREAD_F29 3088 /* offsetof(struct task_struct, thread.fstate.f[29]) */
#define TASK_THREAD_F30 3096 /* offsetof(struct task_struct, thread.fstate.f[30]) */
#define TASK_THREAD_F31 3104 /* offsetof(struct task_struct, thread.fstate.f[31]) */
#define TASK_THREAD_FCSR 3112 /* offsetof(struct task_struct, thread.fstate.fcsr) */
...
#define FREGS_SIZE_ON_STACK 112 /* ALIGN(sizeof(struct ftrace_regs), STACK_ALIGN) */
#define FREGS_EPC 0 /* offsetof(struct ftrace_regs, epc) */
#define FREGS_RA 8 /* offsetof(struct ftrace_regs, ra) */
#define FREGS_SP 16 /* offsetof(struct ftrace_regs, sp) */
#define FREGS_S0 24 /* offsetof(struct ftrace_regs, s0) */
#define FREGS_T1 32 /* offsetof(struct ftrace_regs, t1) */
#define FREGS_A0 40 /* offsetof(struct ftrace_regs, a0) */
#define FREGS_A1 48 /* offsetof(struct ftrace_regs, a1) */
#define FREGS_A2 56 /* offsetof(struct ftrace_regs, a2) */
#define FREGS_A3 64 /* offsetof(struct ftrace_regs, a3) */
#define FREGS_A4 72 /* offsetof(struct ftrace_regs, a4) */
#define FREGS_A5 80 /* offsetof(struct ftrace_regs, a5) */
#define FREGS_A6 88 /* offsetof(struct ftrace_regs, a6) */
#define FREGS_A7 96 /* offsetof(struct ftrace_regs, a7) */
